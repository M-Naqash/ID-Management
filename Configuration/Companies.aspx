<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Companies.aspx.cs" Inherits="Companies_Companies" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                ...
                <table border="0" cellpadding="0" cellspacing="4" width="100%">
                    ...
                    <tr>
                        <td class="td1Allalign" style="width:50%">
                            <span class="requiredStar">*</span>
                            <asp:Label ID="lblNameAr" runat="server" Text="Company Name (Ar) :" 
                    ...
                    <tr>
                        <td class="td1Allalign">
                            <asp:Label ID="lblNameEn" runat="server" Text="Company Name (En) :" 
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="PKID" HeaderText="Company ID" ReadOnly="True" 
                                        SortExpression="PKID" meta:resourcekey="BoundFieldResource1">
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NameAr" HeaderText="Company Name (Ar)" 
                                        SortExpression="NameAr" meta:resourcekey="BoundFieldResource2">
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NameEn" HeaderText="Company Name (En)" 
                                        SortExpression="NameEn" meta:resourcekey="BoundFieldResource3">
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:BoundField>
                                    <%--<asp:BoundField DataField="CreatedBy" 
                                        HeaderText="<%$ Resources:Grid, grdCreatedBy %>" SortExpression="CreatedBy" 
                                        meta:resourcekey="BoundFieldResource4" >
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="<%$ Resources:Grid, grdCreatedDate %>" 
                                        SortExpression="CreatedDate" meta:resourcekey="TemplateFieldResource1">
                                        <ItemTemplate>
                                            <%# DateFun.GrdDisplayDate(Eval("CreatedDate"))%>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="ModifiedBy" 
                                        HeaderText="<%$ Resources:Grid, grdModifiedBy %>" 
                                        SortExpression="ModifiedBy" meta:resourcekey="BoundFieldResource5">
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="<%$ Resources:Grid, grdModifiedDate %>" 
                                        SortExpression="ModifiedDate" meta:resourcekey="TemplateFieldResource2">
                                        <ItemTemplate>
                                            <%# DateFun.GrdDisplayDate(Eval("ModifiedDate"))%>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="GridColumn" />
                                        <ItemStyle CssClass="GridColumn" />
                                    </asp:TemplateField>--%>
